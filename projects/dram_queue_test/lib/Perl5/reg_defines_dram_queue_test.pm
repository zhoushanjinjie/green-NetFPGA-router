...
#
# Project: DRAM queue test (dram_queue_test)
# Description: DRAM queue test
#
#############################################################

package reg_defines_dram_queue_test;
...
@EXPORT = qw(
                ...
                IN_ARB_STATE_REG
                DRAM_QUEUE_SHORTCUT_DISABLE_REG
                DRAM_QUEUE_BLOCK_NUM_REG
                DRAM_QUEUE_SHORTCUT_WORDS_REG
                DRAM_QUEUE_INPUT_WORDS_REG
                DRAM_QUEUE_OUTPUT_WORDS_REG
                DRAM_QUEUE_DRAM_RD_WORDS_REG
                DRAM_QUEUE_DRAM_WR_WORDS_REG
                OQ_QUEUE_0_CTRL_REG
...
sub DEVICE_PROJ_DIR ()  { "dram_queue_test"; }
sub DEVICE_PROJ_NAME () { "DRAM queue test"; }
sub DEVICE_PROJ_DESC () { "DRAM queue test"; }
...
sub DRAM_QUEUE_BASE_ADDR ()      { 0x2000300; }
...
# Name: dram_queue (DRAM_QUEUE)
# Description: DRAM queue registers
# File: projects/dram_queue_test/include/dram_queue.xml
sub DRAM_QUEUE_SHORTCUT_DISABLE_REG ()   { 0x2000300;}
sub DRAM_QUEUE_BLOCK_NUM_REG ()          { 0x2000304;}
sub DRAM_QUEUE_SHORTCUT_WORDS_REG ()     { 0x2000308;}
sub DRAM_QUEUE_INPUT_WORDS_REG ()        { 0x200030c;}
sub DRAM_QUEUE_OUTPUT_WORDS_REG ()       { 0x2000310;}
sub DRAM_QUEUE_DRAM_RD_WORDS_REG ()      { 0x2000314;}
sub DRAM_QUEUE_DRAM_WR_WORDS_REG ()      { 0x2000318;}
