...
`define DRAM_QUEUE_BLOCK_ADDR_WIDTH     19
`define DRAM_QUEUE_REG_ADDR_WIDTH       4
...
`define DRAM_QUEUE_BLOCK_ADDR     19'h0000c
...
`define DRAM_QUEUE_SHORTCUT_DISABLE  4'h0
`define DRAM_QUEUE_BLOCK_NUM         4'h1
`define DRAM_QUEUE_SHORTCUT_WORDS    4'h2
`define DRAM_QUEUE_INPUT_WORDS       4'h3
`define DRAM_QUEUE_OUTPUT_WORDS      4'h4
`define DRAM_QUEUE_DRAM_RD_WORDS     4'h5
`define DRAM_QUEUE_DRAM_WR_WORDS     4'h6
