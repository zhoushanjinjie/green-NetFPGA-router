...
sub IN_ARB_NUM_BYTES_REG ()            { 0x200110c;}
sub IN_ARB_LAST_PKT_CTRL_0_REG ()      { 0x2001110;}
sub IN_ARB_LAST_PKT_WORD_1_HI_REG ()   { 0x2001114;}
sub IN_ARB_LAST_PKT_WORD_1_LO_REG ()   { 0x2001118;}
sub IN_ARB_LAST_PKT_CTRL_1_REG ()      { 0x200111c;}
sub IN_ARB_STATE_REG ()                { 0x2001120;}
