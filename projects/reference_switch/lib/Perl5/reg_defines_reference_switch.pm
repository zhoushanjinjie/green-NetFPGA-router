...
# Description: Reference Switch
#
#############################################################

package reg_defines_reference_switch;
...
sub DEVICE_PROJ_DIR ()  { "reference_switch"; }
sub DEVICE_PROJ_NAME () { "Reference Switch"; }
sub DEVICE_PROJ_DESC () { "Reference Switch"; }
...
sub SWITCH_OP_LUT_PORTS_MAC_HI_REG ()      { 0x2000100;}
sub SWITCH_OP_LUT_MAC_LO_REG ()            { 0x2000104;}
sub SWITCH_OP_LUT_NUM_HITS_REG ()          { 0x2000108;}
sub SWITCH_OP_LUT_NUM_MISSES_REG ()        { 0x200010c;}
sub SWITCH_OP_LUT_MAC_LUT_RD_ADDR_REG ()   { 0x2000110;}
sub SWITCH_OP_LUT_MAC_LUT_WR_ADDR_REG ()   { 0x2000114;}
...
sub IN_ARB_NUM_BYTES_REG ()            { 0x200020c;}
sub IN_ARB_LAST_PKT_CTRL_0_REG ()      { 0x2000210;}
sub IN_ARB_LAST_PKT_WORD_1_HI_REG ()   { 0x2000214;}
sub IN_ARB_LAST_PKT_WORD_1_LO_REG ()   { 0x2000218;}
sub IN_ARB_LAST_PKT_CTRL_1_REG ()      { 0x200021c;}
sub IN_ARB_STATE_REG ()                { 0x2000220;}
