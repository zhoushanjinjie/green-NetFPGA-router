...
@EXPORT = qw(
                ...
                TICKS_ENABLE_TICKS_REG
                TICKS_RESET_TICKS_REG
                TICKS_TICK125_REG
                TICKS_TICK83_3_REG
                TICKS_TICK62_5_REG
                TICKS_TICK12_5_REG
...
sub DEVICE_PROJ_DIR ()  { "ticks"; }
sub DEVICE_PROJ_NAME () { "Reference router With Ticks"; }
sub DEVICE_PROJ_DESC () { "ticks router"; }
...
sub TICKS_BASE_ADDR ()           { 0x2000200; }
sub IN_ARB_BASE_ADDR ()          { 0x2000300; }
...
sub TICKS_ENABLE_TICKS_REG ()   { 0x2000200;}
sub TICKS_RESET_TICKS_REG ()    { 0x2000204;}
sub TICKS_TICK125_REG ()        { 0x2000208;}
sub TICKS_TICK83_3_REG ()       { 0x200020c;}
sub TICKS_TICK62_5_REG ()       { 0x2000210;}
sub TICKS_TICK12_5_REG ()       { 0x2000214;}
sub TICKS_TICK1_25_REG ()       { 0x2000218;}

# Name: in_arb (IN_ARB)
# Description: Round-robin input arbiter
# File: lib/verilog/core/input_arbiter/rr_input_arbiter/xml/rr_input_arbiter.xml
sub IN_ARB_NUM_PKTS_SENT_REG ()        { 0x2000300;}
sub IN_ARB_LAST_PKT_WORD_0_HI_REG ()   { 0x2000304;}
sub IN_ARB_LAST_PKT_WORD_0_LO_REG ()   { 0x2000308;}
sub IN_ARB_NUM_BYTES_REG ()            { 0x200030c;}
sub IN_ARB_LAST_PKT_CTRL_0_REG ()      { 0x2000310;}
sub IN_ARB_LAST_PKT_WORD_1_HI_REG ()   { 0x2000314;}
sub IN_ARB_LAST_PKT_WORD_1_LO_REG ()   { 0x2000318;}
sub IN_ARB_LAST_PKT_CTRL_1_REG ()      { 0x200031c;}
sub IN_ARB_STATE_REG ()                { 0x2000320;}
