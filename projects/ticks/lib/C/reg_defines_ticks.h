 ...
 * Project: Reference router With Ticks (ticks)
 * Description: ticks router
 *
 ********************************************************/

#ifndef _REG_DEFINES_TICKS_
#define _REG_DEFINES_TICKS_
...
#define DEVICE_PROJ_DIR    "ticks"
#define DEVICE_PROJ_NAME   "Reference router With Ticks"
#define DEVICE_PROJ_DESC   "ticks router"
...
#define TICKS_BASE_ADDR          0x2000200
#define IN_ARB_BASE_ADDR         0x2000300
...
// Name: ticks (TICKS)
// Description: System Tick Report
// File: lib/verilog/core/ticks/xml/ticks.xml
#define TICKS_ENABLE_TICKS_REG   0x2000200
#define TICKS_RESET_TICKS_REG    0x2000204
#define TICKS_TICK125_REG        0x2000208
#define TICKS_TICK83_3_REG       0x200020c
#define TICKS_TICK62_5_REG       0x2000210
#define TICKS_TICK12_5_REG       0x2000214
#define TICKS_TICK1_25_REG       0x2000218

// Name: in_arb (IN_ARB)
// Description: Round-robin input arbiter
// File: lib/verilog/core/input_arbiter/rr_input_arbiter/xml/rr_input_arbiter.xml
#define IN_ARB_NUM_PKTS_SENT_REG        0x2000300
#define IN_ARB_LAST_PKT_WORD_0_HI_REG   0x2000304
#define IN_ARB_LAST_PKT_WORD_0_LO_REG   0x2000308
#define IN_ARB_NUM_BYTES_REG            0x200030c
#define IN_ARB_LAST_PKT_CTRL_0_REG      0x2000310
#define IN_ARB_LAST_PKT_WORD_1_HI_REG   0x2000314
#define IN_ARB_LAST_PKT_WORD_1_LO_REG   0x2000318
#define IN_ARB_LAST_PKT_CTRL_1_REG      0x200031c
#define IN_ARB_STATE_REG                0x2000320
