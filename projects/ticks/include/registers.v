...
`define TICKS_BLOCK_ADDR_WIDTH          17
`define TICKS_REG_ADDR_WIDTH            6
...
`define TICKS_BLOCK_ADDR          17'h00002
`define IN_ARB_BLOCK_ADDR         17'h00003
...
`define IN_ARB_NUM_BYTES           6'h3
`define IN_ARB_LAST_PKT_CTRL_0     6'h4
`define IN_ARB_LAST_PKT_WORD_1_HI  6'h5
`define IN_ARB_LAST_PKT_WORD_1_LO  6'h6
`define IN_ARB_LAST_PKT_CTRL_1     6'h7
`define IN_ARB_STATE               6'h8
...
`define TICKS_ENABLE_TICKS  6'h0
`define TICKS_RESET_TICKS   6'h1
`define TICKS_TICK125       6'h2
`define TICKS_TICK83_3      6'h3
`define TICKS_TICK62_5      6'h4
`define TICKS_TICK12_5      6'h5
`define TICKS_TICK1_25      6'h6
