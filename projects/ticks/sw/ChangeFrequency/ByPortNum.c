...
while(1)
	...
	byte_counter += val-rx_0_mac_byte_num;
...
//        byte_counter += val ;
	...
	byte_counter += val-rx_1_mac_byte_num;
...
//        byte_counter += val ;
	...
	byte_counter += val-rx_2_mac_byte_num;
...
//        byte_counter += val ;
	...
	byte_counter += val-rx_3_mac_byte_num;
...
//// 	Changing frequency according to number of active port
	...
	if(byte_counter > 1500) mode = 1 ;
//	else if(flag[ETHERNET_PORT0_FLAG] + flag[ETHERNET_PORT1_FLAG] + flag[ETHERNET_PORT2_FLAG] +flag[ETHERNET_PORT3_FLAG] > 2)mode = 1 ;
