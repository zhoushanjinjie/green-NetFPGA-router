...
package reg_defines_dram_router;
...
sub DEVICE_PROJ_DIR ()  { "dram_router"; }
sub DEVICE_PROJ_NAME () { "DRAM reference router"; }
sub DEVICE_PROJ_DESC () { "DRAM IPv4 Reference Router"; }
