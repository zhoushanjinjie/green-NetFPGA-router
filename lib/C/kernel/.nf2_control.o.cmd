cmd_/root/netfpga/lib/C/kernel/nf2_control.o := gcc -m32 -Wp,-MD,/root/netfpga/lib/C/kernel/.nf2_control.o.d  -nostdinc -isystem /usr/lib/gcc/i386-redhat-linux/4.1.2/include -Iinclude/asm/mach-xen -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -D__XEN_INTERFACE_VERSION__=0x00030203 -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Wstrict-prototypes -Wundef -Werror-implicit-function-declaration -fno-delete-null-pointer-checks -fwrapv -Os -pipe -msoft-float -fno-builtin-sprintf -fno-builtin-log2 -fno-builtin-puts  -mpreferred-stack-boundary=2  -march=i686 -mtune=generic -mtune=generic -mregparm=3 -ffreestanding -Iinclude/asm-i386/mach-xen -Iinclude/asm-i386/mach-default -fomit-frame-pointer -g  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign -O2 -I/root/netfpga/lib/C/kernel/../include  -DMODULE -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(nf2_control)"  -D"KBUILD_MODNAME=KBUILD_STR(nf2)" -c -o /root/netfpga/lib/C/kernel/.tmp_nf2_control.o /root/netfpga/lib/C/kernel/nf2_control.c

deps_/root/netfpga/lib/C/kernel/nf2_control.o := \
  /root/netfpga/lib/C/kernel/nf2_control.c \
  ...
  include/asm/mach-xen/asm/pci.h \
  ...
  include/asm/mach-xen/asm/dma-mapping.h \
  include/asm/mach-xen/asm/swiotlb.h \
